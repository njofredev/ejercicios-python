...
-- https://mockaroo.com/ para rellenar bases de datos
CREATE TABLE UbicacionDpto (
    Numero INT PRIMARY KEY, -- Variable, Lenguaje SQL
...
CREATE TABLE Departamento (
    ...
    Ubicacion INT,  
    FOREIGN KEY (Ubicacion) REFERENCES UbicacionDpto(Numero) -- Debe referenciar a una variable de su propia tabla
); -- Luego a la referencia UbicacionDpto (Primary key / Numero)
